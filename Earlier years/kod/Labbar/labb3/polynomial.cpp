...
Polynomial::Polynomial() //default konstruktor
{
    degree = 0;
}

Polynomial::Polynomial(int d, double a[]) //en vanlig konstruktor
{
    degree = d;
...
Polynomial::Polynomial(double a) //konstruktor om exponenten är 0
{
...
double Polynomial::eval(double x) const
{
    ...
    {
        sum+= this->coef[i] * pow(x, i); //pow(x,i) = x upphöjt till i
    }
    return sum;
}
...
//kan sätta polynom lika med ett annat
