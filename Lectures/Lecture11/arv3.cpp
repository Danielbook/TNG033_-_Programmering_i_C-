...
class Employee
{
  public:
    ...
    //Reference to an Employee (Employee& E) can refer to any object of a sub-class of Employee
    //i.e. E can refer o a Teacher, Programmer, or Researcher
...
{
    //dynamic binding: call function display(os) for the class of the object referred by E
    E.display(os);
